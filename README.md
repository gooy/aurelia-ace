...
An custom element for [Ace editor](http://ace.c9.io).
...
```javascript
jspm install gooy/aurelia-ace
```

And register it as a plugin with aurelia.

```javascript
aurelia.use.plugin('gooy/aurelia-ace');
```

## [Demo & Documentation](https://gooy.github.io/aurelia-ace)

## Dependencies

* [ace](https://github.com/ace/ace-builds)
